  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'runtime/browser/xwalk_presentation_service_session.cc',
        'runtime/browser/xwalk_presentation_service_session_android.cc',
        'runtime/browser/xwalk_presentation_service_session_win.cc',
        'runtime/browser/xwalk_presentation_service_session.h',
